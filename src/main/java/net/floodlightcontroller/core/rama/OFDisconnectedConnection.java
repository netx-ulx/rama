...
/**
 * Copy of MockOFConnection
 * 
 * @author Andre Mantas
 * 
 */
public class OFDisconnectedConnection implements IOFConnectionBackend {
	...
	public OFDisconnectedConnection(DatapathId id, OFAuxId auxId) {
		this.id = id;
		this.auxId = auxId;
