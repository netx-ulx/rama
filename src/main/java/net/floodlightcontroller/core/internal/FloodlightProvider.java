...
public class FloodlightProvider implements IFloodlightModule {
	...
	public void init(FloodlightModuleContext context)
		...
		IOFSwitchService ss = context.getServiceImpl(IOFSwitchService.class);
		controller.setSwitchService(ss);
		controller.setSwitchManager((IOFSwitchManager) ss);

		if (context.getServiceImpl(IReplicationService.class) != null) {
			controller.setReplicationService(context
					.getServiceImpl(IReplicationService.class));
		}
		if (context.getServiceImpl(IBundleService.class) != null) {
			controller.setBundleService(context
					.getServiceImpl(IBundleService.class));
		}
